...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\RecommendationController' => 'getRecommendationControllerService',
    ...
    protected static function getControllerResolverService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\MainController', 'App\\Controller\\RecommendationController']);
